...
internal class DecisionTableFixtureWrapperTest {
    ...
    @Nested
    inner class `life cycle methods can exist multiple times - parallel` {

        val callback = ExtendedLifeCycleFixtureParallel.callback!!
        ...
        private fun execute(): DecisionTableResult {
            ...
            return executeDecisionTable(decisionTable, ExtendedLifeCycleFixtureParallel::class.java)
        }
    }
